...
int main() {
    ...
    const std::string buildDate = "Jul 04 2025";
    ...
    firmwareReport[21] = 0x01;
    firmwareReport[22] = 0x44;
    firmwareReport[24] = 0x08;
    firmwareReport[25] = 0x02;
    firmwareReport[27] = 0x01;
    firmwareReport[28] = 0x36;
    ...
    assert(firmware->firmwareType == 0x0103);
    assert(firmware->softwareSeries == 0x0044);
    assert(firmware->hardwareInfo == 0x01000208);
    assert(firmware->firmwareVersion == 0x01000036);
